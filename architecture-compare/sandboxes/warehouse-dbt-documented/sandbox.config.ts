...
export const config: SandboxConfig = {
  id: 'warehouse-dbt-documented',
  name: 'Warehouse + DBT (Documented)',
...
You have a documented schema in models/schema.yml with column names and join hints.
...
1b. Read models/schema.yml for documented columns and join keys
