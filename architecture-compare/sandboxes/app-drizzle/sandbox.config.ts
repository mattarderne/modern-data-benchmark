...
export const config: SandboxConfig = {
  ...
  systemPrompt: `You are modifying a Drizzle ORM analytics codebase that combines app data and Stripe data.
...
- Use the schema imports for both app + Stripe tables (users, organizations, api_usage, invoices, subscriptions, etc.)
